        ...
        // return address 
            ...
            // specifying a label .END
                (.END)
            
            // goto the specified location .END
                @.END
                0;JMP
        ...
        // goto the .N_LT_2 if stack top value is not zero
            ...
            // goto the specified location .N_GE_2
                @.N_GE_2
                0;JMP
            
            // specifying a label .N_LT_2
                (.N_LT_2)
